...
model.compile(optimizer=SGD(lr=0.001, momentum=0.9, decay=1e-6), loss='categorical_crossentropy',
              metrics=['accuracy'])
...
train_datagen = ImageDataGenerator(
    ...
    rescale=1. / 255            #对图像按照指定的尺度因子, 进行放大或缩小
)
...
checkpointer = ModelCheckpoint(filepath="/home/root01/shuwo/ResNet-on-shuwo/output/012345_weight180314.hdf5",
